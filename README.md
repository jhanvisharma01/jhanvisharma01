...
I’m a **Computer Science graduate specializing in Data Analytics**, passionate about turning **raw data into actionable insights** that drive smarter business decisions.

My background uniquely blends:
- 📊 **Data analysis & visualization**
- 🧠 **Strong technical foundations** (CS + programming)
...
- SQL-driven insights
- Automation & data pipelines (beginner → intermediate)
...
If you enjoy **data storytelling, visualization, and analytics-driven decisions**, let’s talk!
